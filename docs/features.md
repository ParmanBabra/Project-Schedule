...
- **Buffer ถูกล็อกที่ baseline**: เมื่อมี baseline ขนาดเผื่อ (`bufferDays`) และจุดเริ่ม (`buffer.start` = plannedEnd ตอน baseline) จะคงที่ วันสัญญาส่งจึงไม่ขยับตามแผนที่เลื่อน การเปลี่ยนวิธี buffer มีผลเมื่อบันทึก baseline ใหม่เท่านั้น
...
- **มือถือ** ปฏิทินเป็นรายการวัน จ–อา ของสัปดาห์ (ui-design 5.4) ยังไม่มีปัดเปลี่ยนสัปดาห์ ใช้ปุ่ม ‹ › แทน
