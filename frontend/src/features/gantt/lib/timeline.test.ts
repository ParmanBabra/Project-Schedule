...
const project = {
  ...
  tasks: [
    { id: 'a', name: 'A', duration: 3, progress: 0, isMilestone: false, constraint: null, color: null, parentId: null, collapsed: false, order: 1, estimate: null, checklist: [], progressFromChecklist: true },
    { id: 's', name: 'S', duration: 0, progress: 0, isMilestone: false, constraint: null, color: null, parentId: null, collapsed: false, order: 2, estimate: null, checklist: [], progressFromChecklist: true },
    { id: 'b', name: 'B', duration: 5, progress: 0, isMilestone: false, constraint: null, color: null, parentId: 's', collapsed: false, order: 1, estimate: null, checklist: [], progressFromChecklist: true },
    { id: 'm', name: 'M', duration: 0, progress: 0, isMilestone: true, constraint: null, color: null, parentId: null, collapsed: false, order: 3, estimate: null, checklist: [], progressFromChecklist: true },
  ],
  dependencies: [],
  assignments: [],
  ...
  schedule: {
    ...
    buffer: { method: 'ccpm', chainDays: 8, days: 4, start: '2026-09-23', end: '2026-09-29', managementReserveDays: 1, managementReserveEnd: '2026-09-30', percentUsed: 50, note: null, consumedPercent: null, status: null, chainProgress: 0, consumedDays: null, paddingWarning: false, paddingNote: null },
  },
