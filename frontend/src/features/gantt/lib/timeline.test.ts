...
const project = {
  ...
  tasks: [
    { id: 'a', name: 'A', duration: 3, progress: 0, isMilestone: false, constraint: null, color: null, parentId: null, collapsed: false, order: 1, estimate: null, checklist: [], progressFromChecklist: true, epic: null },
    { id: 's', name: 'S', duration: 0, progress: 0, isMilestone: false, constraint: null, color: null, parentId: null, collapsed: false, order: 2, estimate: null, checklist: [], progressFromChecklist: true, epic: null },
    { id: 'b', name: 'B', duration: 5, progress: 0, isMilestone: false, constraint: null, color: null, parentId: 's', collapsed: false, order: 1, estimate: null, checklist: [], progressFromChecklist: true, epic: null },
    { id: 'm', name: 'M', duration: 0, progress: 0, isMilestone: true, constraint: null, color: null, parentId: null, collapsed: false, order: 3, estimate: null, checklist: [], progressFromChecklist: true, epic: null },
  ],
  dependencies: [],
  assignments: [],
